  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" 
      ...
      <div className="relative z-10 w-full max-w-md p-4">
        ...
        <Card className="backdrop-blur-xl border-white/20 shadow-2xl" 
              style={{ 
          ...
          <CardContent>
            <div className="space-y-4">
              <Button 
                ...
                variant="outline" 
                className="w-full h-12 text-base font-medium bg-white/50 border-white/30 hover:bg-white/70 transition-all duration-200"
                disabled={loading}
              >
                  ...
                  <form onSubmit={handleSignIn} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="h-12 bg-white/30 border-white/20 backdrop-blur-sm placeholder:text-muted-foreground/70"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          required
                          className="h-12 bg-white/30 border-white/20 backdrop-blur-sm placeholder:text-muted-foreground/70 pr-12"
                        />
                        <Button
                          type="button"
                          variant="ghost"
                    ...
                    <Button 
                      ...
                      style={{ background: 'var(--gradient-auth-button)' }}
                      disabled={loading}
                    >
